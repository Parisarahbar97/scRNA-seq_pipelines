...
out="/rds/general/user/pr422/projects/puklandmarkproject/ephemeral/Parisa_scdownstream/output_full/run1"
...
nextflow run nf-core/scdownstream \
  -profile imperial > /rds/general/user/pr422/projects/puklandmarkproject/ephemeral/Parisa_scdownstream/output_full/run1/test.log \
  -c "$config_file" \
  --input "$samplesheet" \
  --outdir "$out" \
