...
nextflow run nf-core/scdownstream \
  -r 85a3ca5c56 \
  -profile imperial \
  -c "/rds/general/user/pr422/projects/puklandmarkproject/live/Users/Parisa/scRNA-seq_pipelines/scripts/scdownstream/scdown_scanvi.config" \
  ...
  --outdir "/rds/general/user/pr422/projects/puklandmarkproject/live/Users/Parisa/parisa_scdownstream/output/with_scanvi_parameters" \
